package jp.ac.it_college.std.s22012.listviewreplacesample

import android.view.LayoutInflater
import android.view.ViewGroup
import android.widget.Toast
import androidx.recyclerview.widget.RecyclerView
import jp.ac.it_college.std.s22012.listviewreplacesample.databinding.MenuRowBinding
...
class MenuListAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.root.setOnClickListener {
            val msg = it.resources.getString(R.string.toast_msg, data[position])
