...
val teishokuList = listOf(
    ...
    Menu("青椒肉絲定食",900,"ピーマンの香りが豊かな青椒肉絲にサラダ、ご飯とお味噌汁が付きます"),
    Menu("焼き魚定食",850,"鰆の塩焼きにサラダ、ご飯とお味噌汁が付きます"),
    Menu("焼肉定食",900,"特製タレの焼肉にサラダ、ご飯とお味噌汁が付きます　"),
)
val curryList = listOf(
    Menu("ビーフカレー",520,"特選スパイスをきかせた国産ビーフ100%のカレーです。"),
    Menu("ポークカレー",420,"特選スパイスをきかせた国産ビーフ100%のカレーです。"),
    ...
    Menu("からあげカレー",540,"特選スパイスをきかせたカレーに若鶏の唐揚げをトッピングです。"),
)